var config = {
    ...
    coinUnitPlaces: 8,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in IPBC
    txCoinbaseMinConfirms: 10, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in IPBC
    coinSymbol: 'IPBC',
    openAliasPrefix: "IPBC",
    coinName: 'IPBC',
    coinUriPrefix: 'IPBC:',
    addressPrefix: 0xd1,
    ...
    txChargeRatio: 0.5,
    defaultMixin: 2, // minimum mixin for hardfork v4
    txChargeAddress: '',
    idleTimeout: 30,
